...
<body>
                ...
                <div class="collapse navbar-collapse" id="navmenu">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item fs-5 me-lg-5">
                            <a href="schedule-trip.php" class="nav-link active">Schedule Trip</a>
                        </li>
                        <li class="nav-item fs-5 me-lg-5">
                            <a href="manage-route.php" class="nav-link">Manage Route</a>
                        </li>
                        <li class="nav-item fs-5 me-lg-5">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        require('../../../php/trip-tasks/process-add-trip.php');
    }
    ?>
                ...
                <div class="col bg-light rounded-3 p-5 text-center">
                    ...
                    <form action="add-trip.php" method="post">
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control ps-4 text-center" name="dep-date" id="dep-date" value="<?php if (isset($_POST['dep-date'])) print $_POST['dep-date']; ?>" required />
                        </div>
                        <!-- For JavaScript validation -->
                        <p id="dep-date-feedback" class="text-danger text-end"></p>
                        <div class="input-group mb-3">
                            <label for="dep-time" class="form-label w-35 pt-1 pe-3 text-end">Departure time</label>
                            <input type="time" class="form-control ps-4 text-center" name="dep-time" id="dep-time" value="<?php if (isset($_POST['dep-time'])) print $_POST['dep-time']; ?>" required />
                        </div>
                        <?php
                        require('../../../php/trip-tasks/load-route-and-bus.php');
                        ?>
                        ...
                        <input type="submit" name="schedule-trip" id="schedule-trip" value="SCHEDULE TRIP" class="fs-5 btn btn-success rounded-pill mt-4 py-1 px-4 ms-lg-5" />
                    </form>
                </div>
            </div>
        </div>
