    ...
    <div class="container">
      <div class="row w-75 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">Scheduled Trips</p>
          <?php
          require('../../../php/trip-tasks/view-trips.php');
          ?>
          <a href="add-trip.php">
            <input type="button" name="schedule" id="schedule" value="SCHEDULE NEW TRIP" class="fs-5 btn btn-success rounded-pill mt-4 py-1 w-25" /></a>
        </div>
      </div>
    </div>
  </section>
