    ...
    <div class="container">
      <div class="row w-75 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">Routes</p>
          <?php
          require('../../../php/route-tasks/view-routes.php');
          ?>
          <a href="add-route.php">
            <input type="button" name="add-route" id="add" value="ADD NEW ROUTE" class="fs-5 btn btn-success rounded-pill mt-4 py-1 w-25" /></a>
        </div>
      </div>
    </div>
  </section>
