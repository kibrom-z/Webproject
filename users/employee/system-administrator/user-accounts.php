    ...
    <div class="container">
      <div class="row m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">User Accounts</p>
          <?php
          require('../../../php/user-tasks/view-user-accounts.php');
          ?>
          <a href="create-account.php">
            <input type="button" name="create-acc" value="CREATE NEW ACCOUNT" class="fs-5 btn btn-success rounded-pill mt-4 py-1 w-25" id="create" /></a>
        </div>
      </div>
    </div>
  </section>
