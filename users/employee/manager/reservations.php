        ...
        <div class="collapse navbar-collapse" id="navmenu">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item fs-5 me-lg-5">
              <a href="select-route.php" class="nav-link">Assign Tariff</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
              <a href="view-reports.php" class="nav-link">Report</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
              <a href="select-reservations.php" class="nav-link active">Reservations</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
    ...
    <div class="container">
      <div class="row w-75 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          ...
          <p class="text-start fs-5 lead"><?php print '' . $_SESSION['departure-city'] . ' — ' . $_SESSION['arrival-city'] . ' (' . $_SESSION['departure-date'] . ')'; ?></p>
          <?php
          require('../../../php/reservation-tasks/process-view-reservations.php');
          ?>
          <a href="select-reservations.php">
            <input type="button" name="back-button" id="back-button" value="GO BACK" class="fs-5 btn btn-success rounded-pill mt-4 py-1 w-25">
          </a>
        </div>
      </div>
    </div>
