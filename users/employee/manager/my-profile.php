      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navmenu">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item fs-5 me-lg-5">
              <a href="select-reservations.php" class="nav-link">Reservations</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
              <a href="my-profile.php" class="nav-link active">My Profile</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
    ...
    <div class="container">
      <div class="row w-50 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">Update desired fields</p>
          <?php
          require('../../../php/user-tasks/process-employee-profile-update.php');
          ?>
        </div>
      </div>
    </div>
