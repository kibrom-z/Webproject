...
<body>
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    require('../../../php/reservation-tasks/process-reservation-view-input.php');
  }
  ?>
    ...
    <div class="container">
      <div class="row w-50 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">Fill the form to view reservations</p>
          <form action="select-reservations.php" method="post">
            <?php
            require('../../../php/reservation-tasks/load-cities.php');
            ?>
