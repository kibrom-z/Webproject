...
<body>
        ...
        <div class="collapse navbar-collapse" id="navmenu">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item fs-5 me-lg-5">
              <a href="one-way-trip.php" class="nav-link active">Book</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    require('../../php/booking-tasks/one-way-trip/process-passenger-detail.php');
  }
  ?>
    ...
    <div class="container">
      <div class="row w-50 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          ...
          <form action="passenger-detail.php?id=<?php print $_SESSION['selected-trip-id']; ?>" method="post">
            ...
            <div class="input-group mb-3">
              ...
              <select name="sex" class="form-select" id="sex" style="width: 220px">
            ...
            <div class="input-group mb-3">
              <label for="board-place" class="form-label w-35 pt-1 pe-3 text-end">Boarding place</label>
              <input type="text" class="form-control ps-4" name="board-place" id="board-place" maxlength="20" value="<?php if (isset($_POST['board-place'])) print $_POST['board-place']; ?>" placeholder="Optional" />
            </div>
            <?php
            require('../../php/booking-tasks/one-way-trip/display-trip-info.php');
            ?>
            <a href="one-way-trip.php">
              <input type="button" name="back" value="GO BACK" id="back-button" class="fs-5 btn btn-success rounded-pill mt-5 py-1 px-5 me-lg-5" /></a>
            <?php
            if ($_SESSION['manipulable-adult-number'] == 1) {
              print '<input type="submit" name="confirm" value="CONFIRM DETAIL" id="confirm-button" class="fs-5 btn btn-success rounded-pill mt-5 py-1 px-4 ms-lg-5" />';
            } else {
              print '<input type="submit" name="next" value="NEXT PASSENGER" id="next-button" class="fs-5 btn btn-success rounded-pill mt-5 py-1 px-4 ms-lg-5" />';
            }
            ?>
          </form>
        </div>
