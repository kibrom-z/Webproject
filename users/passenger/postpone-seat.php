    ...
    <div class="container">
      <div class="row w-75 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">Seat Selection</p>
          <form action="postpone-seat.php" method="post" class="small-container">
            <?php
            require('../../php/booking-tasks/auxiliary/process-seat-selection.php');
            ?>
            <input type="submit" name="payment" value="NEXT" class="fs-5 btn btn-success rounded-pill mt-5 py-1 w-25" id="payment-button" />
          </form>
        </div>
      </div>
    </div>
