    ...
    <div class="container">
      <div class="row w-50 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          ...
          <?php
          require('../../../php/booking-tasks/round-trip/display-passengers.php');
          require('../../../php/booking-tasks/round-trip/display-trip-info2.php');
          ?>
          <a href="seat.php">
    ...
    <section class="bg-dark text-light py-sm-5">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg m-3">
            <p class="mb-3 fs-5 fw-bold text-light">Developeb By </p>
            <ol>
