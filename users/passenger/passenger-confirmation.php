    ...
    <div class="container">
      <div class="row w-50 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">Passenger Information</p>
          <div class="row border border-secondary rounded p-3 mb-4">
            <div class="col"><img src="../../images/icons/info_20px.png" alt="info" class="float-start mt-3" />
              <p class="text-start ms-5">
                Please make sure these details exactly match the identity document.
                It can't be changed once booking is completed.
              </p>
            </div>
          </div>
          <?php
          require('../../php/booking-tasks/one-way-trip/display-passengers.php');
          require('../../php/booking-tasks/one-way-trip/display-trip-info2.php');
          ?>
          <a href="seat.php">
            <input type="button" name="seat" value="SELECT SEAT" class="fs-5 btn btn-success rounded-pill mt-5 py-1 w-35" /></a>
        </div>
      </div>
    </div>
  </section>
