...
<body>
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    require('../../php/booking-tasks/one-way-trip/process-find-trips.php');
  }
  ?>
      ...
      <div class="row w-50 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <ul class="nav nav-tabs justify-content-center mb-5 fs-5">
            <li class="nav-item">
              <a href="one-way-trip.php" class="nav-link text-success active">One Way Trip</a>
            </li>
            <li class="nav-item">
              <a href="round-trip/round-trip.php" class="nav-link text-secondary">Round Trip</a>
            </li>
          </ul>
          <form action="one-way-trip.php" method="post">
            <?php
            require('../../php/booking-tasks/one-way-trip/load-cities.php');
            ?>
