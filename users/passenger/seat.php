      ...
      <div class="row w-75 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          ...
          <form action="seat.php" method="post">
            <?php
            require('../../php/booking-tasks/one-way-trip/process-seat-selection.php');
            ?>
            <a href="passenger-confirmation.php">
            ...
            <input type="submit" name="payment" value="GO TO PAYMENT" class="fs-5 btn btn-success rounded-pill mt-5 py-1 px-4 ms-lg-5" id="payment-button" />
          </form>
        </div>
      </div>
    </div>
