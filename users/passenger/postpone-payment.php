...
<head>
  ...
  <title>Postpone — Payment</title>
  <link rel="stylesheet" href="../../bootstrap-5.2.2-dist/css/bootstrap.css" />
  <link rel="stylesheet" href="../../css/background-image.css">
  <link rel="stylesheet" href="../../css/payment-hover.css">
        ...
        <div class="collapse navbar-collapse" id="navmenu">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item fs-5 me-lg-5">
              <a href="one-way-trip.php" class="nav-link">Book</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
              <a href="my-trips.php" class="nav-link active">My Trips</a>
            </li>
            <li class="nav-item fs-5 me-lg-5">
    ...
    <div class="container">
      <div class="row w-50 m-auto mt-3">
        <div class="col bg-light rounded-3 p-5 text-center">
          <p class="fs-4 text-success mb-5">Select payment option</p>
          <a href="../bank-system/Trip-postpone-simulator.php" class="text-decoration-none text-dark">
            <div class="row">
              <div class="col border rounded pt-3 m-3">
                <figure>
                  <img src="../../images/bank-logos/cbe-logo.png" alt="cbe" />
                  <figcaption>CBE</figcaption>
                </figure>
              </div>
              <div class="col border rounded pt-3 m-3">
                <figure>
                  <img src="../../images/bank-logos/abyssinia-logo.png" alt="cbe" />
                  <figcaption>Abyssinia Bank</figcaption>
                </figure>
              </div>
              <div class="col border rounded pt-3 m-3">
                <figure>
                  <img src="../../images/bank-logos/anbessa-logo.png" alt="cbe" />
                  <figcaption>Anbessa Bank</figcaption>
                </figure>
              </div>
            </div>
            <div class="row">
              <div class="col border rounded pt-3 m-3">
                <figure>
                  <img src="../../images/bank-logos/telebirr-logo.png" alt="cbe" />
                  <figcaption>Telebirr</figcaption>
                </figure>
              </div>
              <div class="col border rounded pt-3 m-3">
                <figure>
                  <img src="../../images/bank-logos/wegagen-logo.png" alt="cbe" />
                  <figcaption>Wegagen Bank</figcaption>
                </figure>
              </div>
              <div class="col border rounded pt-3 m-3">
                <figure>
                  <img src="../../images/bank-logos/dashen-logo.png" alt="cbe" />
                  <figcaption>Dashen Bank</figcaption>
                </figure>
              </div>
            </div>
          </a>
          <a href="postpone-seat.php">
