...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if ($total_price <= $balance) {
            ...
            mysqli_stmt_bind_param($prepared4, "i", $_SESSION['selected-trip-id']);
            ...
            mysqli_stmt_bind_param($q5, 'ii', $new_bookings, $_SESSION['selected-trip-id']);
            ...
            if ((mysqli_stmt_affected_rows($q2) == 1) &&
                ...
                header('location: ../../php/booking-tasks/one-way-trip/successful-booking.php');
            } else {
    ...
    <fieldset class="border border-secondary rounded mb-3 p-3">
        ...
        <form action="One-way-trip-simulator.php" method="post">
            <div class="input-group mb-3">
