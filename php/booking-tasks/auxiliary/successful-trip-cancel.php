        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Trip cancel successful</p>
                    <p class="fs-5 text-start">Your booking has been cancelled successfully. You will have your money returned shortly. Thank you for using our service.</p>
