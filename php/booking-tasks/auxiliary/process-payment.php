...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if ($total_price <= $balance) {
            ...
            if ((mysqli_stmt_affected_rows($q2) == 1) &&
                ...
                $errors[] = 'Payment not completed due to a system error. We apologize for any inconvinience.';
    ...
    <fieldset class="border border-secondary rounded mb-3 p-3">
        ...
        <form action="Trip-postpone-simulator.php" method="post">
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3" style="font-weight: bold;">
                <label for="amount" class="form-label w-35 pt-1 pe-3 text-end">Tariff increase</label>
                <input type="text" class="form-control ps-4" name="amount" id="amount" value="' . $total_price . ' Birr" style="color: black; font-weight: bold;" disabled />
            </div>
            <div class="input-group mb-3">
