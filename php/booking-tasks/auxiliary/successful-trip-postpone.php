...
require('process-delete-old-trip.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Successful postpone</title>
        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Postpone successful</p>
                    <p class="fs-5 text-start">Your postponed booking has been completed successfully. A digital ticket has been sent to your email. Thank you for using our service.</p>
