        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Profile updated</p>
                    <p class="fs-5 text-start">The account has been successfully updated. You have been signed out of your account. Please sign in with your new user information.</p>
                    <a href="../authorization-tasks/process-sign-out.php">
                        <input type="button" name="ok" value="OK" class="fs-5 btn btn-success rounded-pill mt-4 py-1 w-50" id="ok" /></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                ...
                <li>Filmon Hayelom</li>
                    ...
                    <div class="col-lg m-3">
                        ...
                        <p>
                            <a href="../../users/employee/tutorial.html" class="text-decoration-none text-light">Tutorial</a>
                        </p>
                    </div>
                    <div class="col-lg m-3">
                        <p class="mb-3 fs-5 fw-bold text-light">Company</p>
                        <p><a href="../../users/employee/about.html" class="text-decoration-none text-light">About</a></p>
                        <p>
                            <a href="../../users/employee/contact.html" class="text-decoration-none text-light">Contact</a>
                        </p>
                    </div>
                </div>
            </div>
