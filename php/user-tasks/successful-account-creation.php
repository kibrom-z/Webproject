...
<body>
    ...
    <section class="content">
        <div class="large-container">
            <p class="container-title">Account creation successful</p>
            <ul id="msg">
                <li class="text">The user account has been created successfully.</li>
                <li class="text">They can now use their account to sign in and use our services.</li>
                <li class="text">They must not forget thier username and password.</li>
            </ul>
            <div class="field">
                <a href="../../users/employee/system-administrator/user-accounts.php">
