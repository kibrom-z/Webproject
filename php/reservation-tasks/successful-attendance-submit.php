        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Attendance submitted</p>
                    <p class="fs-5">The attendance has been successfully submitted.</p>
                    <a href="../../users/employee/bus-attendant/select-trip-id.php">
