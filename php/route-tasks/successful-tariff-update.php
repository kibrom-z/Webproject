...
<head>
    ...
    <title>Successful tariff assignment</title>
        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Tariff assignment successful</p>
                    <p class="fs-5 text-start">The new tariff has been successfully assigned to the route.</p>
                    <a href="../../users/employee/manager/select-route.php">
