...
<head>
    ...
    <title>Successful route delete</title>
        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Route deletion successful</p>
                    <p class="fs-5 text-start">The route has been successfully deleted from the database on your request.</p>
                    <div class="field">
                        <a href="../../users/employee/dispatcher/manage-route.php">
