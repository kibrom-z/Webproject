...
<head>
    ...
    <title>Successful route addition</title>
        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Route addition successful</p>
                    <p class="fs-5 text-start">The new route has been successfully added to the database.</p>
