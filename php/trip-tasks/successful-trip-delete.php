...
<head>
    ...
    <title>Successful trip deletion</title>
        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Trip deletion successful</p>
                    <p class="fs-5 text-start">The trip has been successfully deleted from the database.</p>
                    <a href="../../users/employee/dispatcher/schedule-trip.php">
