...
<head>
    ...
    <title>Successful trip schedule</title>
        ...
        <div class="container">
            <div class="row w-50 m-auto mt-3">
                <div class="col bg-light rounded-3 p-5 text-center">
                    <p class="fs-4 text-success mb-5">Trip schedule successful</p>
                    <p class="fs-5 text-start">The new trip has been successfully added to the database.</p>
